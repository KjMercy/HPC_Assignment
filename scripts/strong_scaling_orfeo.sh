...
#SBATCH --ntasks=8                  # total MPI tasks across nodes
...
srun --ntasks=8 --cpus-per-task=16  --cpu-bind=cores  ./main -p 0 -o 0 -e 300 -v 1 > ../outputs/output_strong_1_node_8taskpernode_16cpupertask.log